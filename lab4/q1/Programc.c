...
struct node *polyadd (struct node *p1thead, struct node *p2thead);
struct node *polysub (struct node *p1thead, struct node *p2thead);
...
{
  int a, b, n, i;
  struct node *p1head, *p2head, *adds, *subs;
  p1head = p2head = NULL;
  ...
  adds = polyadd (p1head, p2head);
  subs = polysub (p1head, p2head);
...
struct node *
append (struct node *thead, int c, int e)
{
...
struct node *
insertpoly (struct node *thead, int c, int e)
{
  struct node *newnode = (struct node *) malloc (sizeof (struct node));
  newnode->coef = c;
  newnode->expo = e;
...
struct node *
polyadd (struct node *p1thead, struct node *p2thead)
{
...
struct node *
polysub (struct node *p1thead, struct node *p2thead)
{
  struct node *ans = NULL;
  struct node *t1, *t2;
  t1 = p1thead;
